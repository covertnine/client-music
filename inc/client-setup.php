...
function c9music_register_block_patterns()
{
	if (class_exists('WP_Block_Patterns_Registry')) {
		...
		register_block_pattern(
			...
			array(
				'title'			=> __('Article 600 Words', 'c9-music'),
