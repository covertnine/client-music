...
<?php if ( $order->has_status( 'pending' ) ) { ?>
	...
	?>
		...
		<p>
		Payments are due 15 days from invoice date. (Net 15 Days) We reserve the right to charge 1.5% per month finance charge on balances not paid within 15 days.
	</p>
